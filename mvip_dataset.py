...
MVIP_MINI_DIR = "/home/hofmpaul/Documents/Repositories/Bachelorarbeit-Synthetische-Daten/_datasets/mvip-mini"
...
class MVIPDatasetSupCon(Dataset):
    ...
    def crop_object(self, image: Image, mask: Image):
        ...
        return crop_object(image, np.array(mask))
