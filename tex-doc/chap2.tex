...
Die finale Verlustfunktion setzt sich aus dem Rekonstruktionsfehler und der KL-Divergenz zusammen, wie in \autoref{eq:vae-loss} formuliert. Sie sorgt dafür, dass der so genannte Evidence Lower Bound (ELBO) maximiert wird, welche als Näherung der zu maximierenden Log-Likelihood der Daten $p(x)$ dient, also der Wahrscheinlichkeit, dass das Modell die Trainingsdaten richtig beschreibt.
