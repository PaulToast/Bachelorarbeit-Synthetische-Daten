...
% Schwellenwert
Idealerweise sollte ein neuronales Netz höhere Softmax-Wahrscheinlichkeiten für In-Distribution-Daten und niedrigere Wahrscheinlichkeiten für OOD-Daten ausgeben. Tatsächlich sind die Wahrscheinlichkeiten für OOD-Daten fast immer sehr hoch, meist reicht aber der Abstand zwischen In-Distribution und OOD-Daten aus, um einen Schwellenwert festzulegen und OOD-Instanzen frühzeitig zu identifizieren \parencite{Hendrycks2018baselineooddetection}.
...
Grundlage der Forschungsarbeit ist der am Fraunhofer-IPK entstandene MVIP-Datensatz \parencite{Koch2023mvip}, wobei MVIP für \textit{Multiview Industrial Parts} steht. Der Datensatz beinhaltet Bilder und andere Sensordaten zu verschiedenen industriellen Objekten, darunter hauptsächlich Autoteile. Er wurde im Rahmen des Projekts “Sensorische Erfassung, automatisierte Identifikation und Bewertung von Altteilen anhand von Produktdaten sowie Informationen über bisherige Lieferungen” (EIBA) erstellt, indem ... \parencite{ReziProK2019eiba}.
...
Insgesamt enthält der MVIP-Datensatz ... Bilder, die in ... Klassen eingeteilt sind. Die Klassen sind ungleichmäßig verteilt, wobei einige Klassen nur wenige Bilder enthalten, während andere sehr viele Bilder haben. ...
