...
\section{Semantische Datenaugmentation mit DA-Fusion}

...

\section{Robuste Datenrepräsentation durch Contrastive Learning}

% Einleitung; Sprung von synthetischen Daten auf Contrastive Learning abfedern
% Ursprung Contrastive Learning
% Die Grundprinzipien
% Self-Supervised *Instance* Discrimination vs. Supervised *Class* Discrimination (Keshtmand2022)
...
\subsection{“Schlechte” synthetische Daten als negativ-Beispiele im\ Contrastive Learning?}
