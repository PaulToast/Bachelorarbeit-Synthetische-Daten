...
% Andere Ansätze
Oftmals ist die OOD-Detektion aber weniger trivial, etwa wenn sich In-Distribution und OOD-Daten sehr ähnlich sind. Auch im Falle von Overfitting können OOD-Daten mit hohen Wahrscheinlichkeiten falsch klassifiziert werden, wenn sie in irgendeiner Weise ähnliche Merkmale aufweisen. Es wird daher stets nach alternativen Ansätzen gesucht, um die OOD-Detektion zu verbessern. Ein simples Beispiel ist das Training eines binären Klassifikators, der zwischen In-Distribution und OOD-Daten unterscheidet.
