...
- einmal ID-Augmentationen, einmal OOD-Augmentationen
...
- es soll einerseits der Effekt der "normalen" ID-Augmentationen aufs Training untersucht werden, und andererseits der Effekt der OOD-Augmentationen im Contrastive Pre-Training als Spezialfall
