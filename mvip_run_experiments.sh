...
python main_supcon.py --dataset=mvip --output_name="mvip-test-supcon-pre" --trial=0 \
...
python main_supcon.py --dataset=mvip --output_name="mvip-test-supcon-pre" --trial=1 \
...
python main_supcon.py --dataset=mvip --output_name="mvip-test-supcon-pre" --trial=2 \
...
# Run 1: With real images only
python main_linear.py --dataset=mvip --output_name="mvip-test-supcon-lin" --trial=0 \
...
python main_linear.py --dataset=mvip --output_name="mvip-test-supcon-lin" --trial=1 \
--aug_mode="with_id" --aug_output_name="mvip-test-dafusion" --aug_name_id="augs-id" \
...
python main_linear.py --dataset=mvip --output_name="mvip-test-supcon-lin" --trial=2 \
--aug_mode="with_both" --aug_output_name="mvip-test-dafusion" --aug_name_id="augs-id" \
