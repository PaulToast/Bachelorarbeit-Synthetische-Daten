...
python sup-contrast/main_supcon.py --dataset=mvip --output_name="mvip-test-supcon-pre" \
...
# Run 1: With real images only
python sup-contrast/main_linear.py --dataset=mvip --output_name="mvip-test-supcon-lin" \
